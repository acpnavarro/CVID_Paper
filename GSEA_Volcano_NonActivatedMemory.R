...
df <-read_excel("data/df.IB_CVIDxHD.xlsx")
# log2 fold change 
...
nes_value <- round(gse@result[gse@result$ID == "GO:0007259", "NES"], 2)
...
##Single Reactome plot -  TLR9
# Extract NES and adjusted p-value
nes_value <- round(react@result[react@result$ID == "R-HSA-168138", "NES"], 2)
...
# Generate the GSEA plot
tlr9<- gseaplot2(react,
                 geneSetID = "R-HSA-168138",
                 title = plot_title)
...
ggsave("volcanoIB_CVIDxHD.png", dpi = 300, width = 10, height = 8)
